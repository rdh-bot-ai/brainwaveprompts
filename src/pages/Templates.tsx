      ...
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold mb-4">Prompt Templates</h1>
              ...
              >
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-start">
                    <Badge
                      className={`${getTierBadgeColor(template.tier)} font-medium`}
                    >
                ...
                <CardContent>
                  <div
                    className={`bg-gray-50 p-3 rounded-md relative ${
                      !canAccessTemplate(template.tier) ? "blur-sm" : ""
                    }`}
                  >
