              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="projectType" name="projectType" value={formData.projectType} onChange={handleInputChange} placeholder="e.g. Content Generation, Customer Support, etc." />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="timeline" name="timeline" value={formData.timeline} onChange={handleInputChange} placeholder="e.g. 2-3 weeks, ASAP, etc." />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="budget">Budget Range</Label>
                    <Input id="budget" name="budget" value={formData.budget} onChange={handleInputChange} placeholder="e.g. $5,000-$10,000" />
                  </div>
                </div>
                
                <div className="space-y-2">
                  <Label htmlFor="description">Project Description *</Label>
                  <Textarea id="description" name="description" value={formData.description} onChange={handleInputChange} placeholder="Please describe your project, goals, and specific requirements. Include any existing challenges you're facing with AI prompts." className="min-h-[120px]" required />
                </div>
